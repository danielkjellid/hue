...
function registerThemeStore(Alpine2, storageKey) {
  Alpine2.store("theme", {
...
// src/hue/static/js/index.js
window.Alpine = module_default2;
module_default2.plugin(module_default);
function configureAlpine({ csrfToken, themeStorageKey }) {
  module_default.configure({
    mergeStrategy: "update",
    headers: {
      "X-CSRFToken": csrfToken
    }
  });
  registerThemeStore(module_default2, themeStorageKey);
  module_default2.start();
  return module_default2;
}
export {
  module_default2 as Alpine,
  module_default as ajax,
  configureAlpine
};
